...
def patient_add_params_check(content):
    ...
    if "relation" not in content or str.isdigit(
            str(content["relation"])) is False:
        # 数字
...
def patient_update_params_check(content):
    ...
    if 'birthdate' in content and str.isdigit(
            str(content["birthdate"])) is False:
        # 数字
        return "birthdate", False
    ...
    if "relation" in content and str.isdigit(
            str(content["relation"])) is False:
        # 数字
        return "relation", False
    ...
    if "department" in content and str.isdigit(
            str(content["department"])) is False:
        # 数字
        return "department", False
