...
class Transfusion(db.Model):
    ...
    nurseId = db.Column(db.Integer, nullable=False, doc="护士编号")  # immutable
    patientId = db.Column(db.Integer, nullable=False, doc="患者编号")  # immutable
    ...
    vein = db.Column(db.Integer, nullable=False, doc="静脉编号")
    tool = db.Column(db.Integer, nullable=False, doc="工具编号")
...
class TransfusionDrug(db.Model):
    ...
    transfusionId = db.Column(db.Integer, nullable=False, doc="输液记录编号")  # immutable
    seq = db.Column(db.Integer, nullable=False, doc="序号")
    drug = db.Column(db.Integer, nullable=False, doc="药物编号")
